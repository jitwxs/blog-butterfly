...
![Developer settings](/images/posts/20180522220116657.png)

进入后点击 `New Oauth App`，如图所示：

![New Oauth App](/images/posts/20180522220217602.png)

在其中填写`主页 URL` 和 `回调 URL`，回调 URL 尤为重要，如果不太明白可以先和我一致。

![Register Oahth App](/images/posts/20180522220322239.png)

点击注册后，上方会生成 `Client ID` 和 `Client Secret`，这两个后面要用到。

![Register Oahth App](/images/posts/20180522220445688.png)
...
![QQ 互联管理中心](/images/posts/20180522223423451.png)

然后注册应用信息，和 GitHub 的步骤大差不差：

![注册应用1](/images/posts/20180522223442610.png)

![注册应用2](/images/posts/20180522223549819.png)
...
![应用接口](/images/posts/20180522223636727.png)
