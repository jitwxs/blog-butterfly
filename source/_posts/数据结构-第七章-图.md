...
![](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20171107164935361.png)
...
![](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924013544750.png)
...
![](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924013559043.png)
...
![](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20171107165302919.png)
...
![](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20171107170257188.png)

在有向图 $G=(V,{A})$中，若对于每对顶点 $v_i、v_j \in V$ 且 $v_i \neq v_j$，从 $v_i$ 到 $v_j$ 和 $v_j$ 到 $v_i$ 都有路径，则称该有向图为`强连通图`。**有向图的极大强连通子图**称做有向图的`强连通分量`。

![强连通图](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924014155942.png)
...
![生成树](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924014409918.png)

在非连通图G中，由每个连通分量都可以得到一个极小连通子图（一棵生成树）。这些连通分量的生成树就组成了一个非连通图的`生成森林`。

![生成森林](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924014423883.png)
...
![图的邻接矩阵表示](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924015009710.png)

![](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20171107172022971.png)

##### 7.2.1.2 网的邻接矩阵表示

类似地可以定义网的邻接矩阵：

![网的邻接矩阵表示](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924015107845.png)

![](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20171107172119683.png)
...
![邻接表](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924015616266.png)

下图为某网的邻接表和网络图的示例：

![邻接表例子](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924015647300.png)
...
![邻接矩阵实现DFS](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924020520365.png)
...
![邻接表实现DFS](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924020734962.png)
...
![邻接矩阵实现BFS](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924021118078.png)
...
![邻接表实现BFS](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924021333979.png)
...
![生成树问题1](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924021607653.png)

![生成树答案1](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924021641664.png)

例2：画出下图的最小生成树

![生成树问题2](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924021730987.png)

![生成树答案2](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924021811849.png)
...
![Kruskar](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924022259223.png)
...
![7.5.1.3题目](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924022726419.png)

![7.5.1.3答案](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924022801653.png)
...
![](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924023630111.png)
...
![关键路径](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924024026315.png)
...
![7.8.6题目](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924024513481.png)

![7.8.6答案](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924024542095.png)

#### 7.8.7 例7
已知二维数组表示的图的邻接矩阵如下图所示。试分别画出自顶点1出发进行遍历所得的深度优先生成树和广度优先生成树。

![7.8.7](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924024629956.png)

#### 7.8.8 例8
试利用Dijkstra算法求图中从顶点a到其他各顶点间的最短路径，写出执行算法过程中各步的状态。

![7.8.8题目](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924024716360.png)

>解：最短路径为：（a,c,f,e,d,g,b）。

![7.8.8答案](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924024804121.png)
...
![7.8.9题目](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924024847943.png)

解：
（1）最小生成树如下图所示。

![7.8.9答案1](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924024940104.png)

（2）邻接矩阵表示和邻接表表示。

![7.8.9答案2](https://cdn.jsdelivr.net/gh/jitwxs/cdn/blog/posts/20170924025014107.png)
